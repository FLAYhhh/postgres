 ...
 * ptbm redesign:
 *   pte_t can be merged with BufferDesc
 */
#pragma pack(push,1)
typedef struct {
    size_t present : 1; // 
    ...
    size_t size : 1;
    size_t global : 1;
    size_t softw1: 1; // _PAGE_BIT_SPECIAL
    size_t softw2: 1; // only this is unused (https://01.org/blogs/dave/2020/linux-consumption-x86-page-table-bits)
    size_t softw3: 1; // _PAGE_BIT_SOFT_DIRTY
    size_t pfn : 28;
    size_t reserved_1 : 12;
    size_t ignored_1 : 11;
    size_t execution_disabled : 1;
...
extern ptedit_paging_definition_t ptedit_paging_definition;
